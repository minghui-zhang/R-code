...
harmonic_nls_simple_algorithm <- function(ts, window_EVI_1, window_EVI_2, numMissingPts, risingLimb_start_DOY, risingLimb_end_DOY, fallingLimb_start_DOY, fallingLimb_end_DOY, fittingStartDay, fittingEndDay) {
  ...
  plot(ts_R$t, EVI_smoothed2, main = "1st order harmonic nls") 
  lines(ts_R$t, EVI_smoothed2, col = "green") 
  lines(ts_R$t, fitted(model_nls1), col = "red")
  abline(v = date_min, col = "blue")
  abline(v = date_max - quarter_period_comparable, col = "red")
...
print(harmonic_nls_simple_algorithm(ts, 0, 0, 0, 50, 170, 150, 210, '2016-09-01', '2017-02-01'))
```

## Harmonic nls computation

```{r}
test_smoothing_harmonic_nls_simple(ts, 50, seq(0, 10), c(0, 0, 20), c(0, 20, 20), c('no smoothing', 'half smoothing', 'full smoothing'), 50, 120, 110, 190, '2016-10-01', '2017-03-01')
```
