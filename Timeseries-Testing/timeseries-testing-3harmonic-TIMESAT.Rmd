...
harmonic_TIMESAT_algorithm <- function(ts, window_EVI_1, window_EVI_2, numMissingPts, risingLimb_start_DOY, risingLimb_end_DOY, fallingLimb_start_DOY, fallingLimb_end_DOY, fittingStartDay, fittingEndDay) {
  ...
  plot(t_fitting, EVI_smoothed2, main = "3rd order harmonic, nls")
...
```{r}
print(harmonic_TIMESAT_algorithm(ts, 0, 0, 0, 50, 170, 150, 210, '2016-09-01', '2017-07-01'))
```

## Computations for harmonic TIMESAT
```{r}
test_smoothing_harmonic_TIMESAT(ts, 50, seq(0, 10), c(0, 0, 20), c(0, 20, 20), c('no smoothing', 'half smoothing', 'full smoothing'), 50, 190, 170, 240, '2016-09-01', '2017-07-01')
```
