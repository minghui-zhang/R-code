...
## My GEE algorithm (in a function)
...
R_GEE_algorithm <- function(ts, window_EVI_1, window_EVI_2, window_dEVI, numMissingPts) {
  ...
  plot(ts_firstCropFitting_R$t, EVI_fitting)
  lines(ts_firstCropFitting_R$t, EVI_fitting, col = "green")
  lines(ts_firstCropFitting_R$t, fitted(model_GEE_harmonic), col = "red")
...
GEE_results <- R_GEE_algorithm(ts, 10, 10, 0, 8)
```
## My GEE algorithm
